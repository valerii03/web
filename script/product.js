document.addEventListener("DOMContentLoaded", () => {
    ...
    const headerTitle = document.querySelector(".cart-header-title");
    if (headerTitle) {
        ...
        productDetails.innerHTML = `
            <div class="product-container">
                ...
                <div class="product-info">
                    <h1>Назва: ${product.title}</h1>
                    <p><strong>Категорія:</strong> ${product.category}</p>
                    <p><strong>Ціна:</strong> ${product.price} грн</p>
                    ${product.oldPrice ? `<p><strong>Стара ціна:</strong> <del>${product.oldPrice} грн</del></p>` : ''}
